...
public class SelectableSquare : MonoBehaviour, IShape
{
    ...
    public bool PosInside(Vector2 point)
    {
        Vector2 center = gameObject.transform.position;
        float scale = gameObject.transform.localScale.x / 2;

        float leftBound = center.x - scale;
        float rightBound = center.x + scale;
        float topBound = center.y + scale;
        float bottomBound = center.y - scale;
